# Provider Versioning Guide Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Create a comprehensive Terraform provider versioning reference guide at `docs/provider-versioning.md`

**Architecture:** Single markdown reference document with six main sections, using project artifacts (versions.tf, .terraform.lock.hcl) as practical examples. Each section includes explanation, syntax examples, and best practices.

**Tech Stack:** Markdown, Terraform configuration examples, bash command output

---

### Task 1: Read existing project files for reference examples

**Files:**
- Read: `versions.tf`
- Read: `.terraform.lock.hcl`
- Read: `provider.tf`
- Read: `docs/zadatak1/zadatak1.md`

**Step 1: Read versions.tf**

Run: `cat versions.tf`
Purpose: Extract current provider version configuration to use as example

**Step 2: Read .terraform.lock.hcl**

Run: `cat .terraform.lock.hcl`
Purpose: Analyze lock file structure for documentation examples

**Step 3: Read provider.tf**

Run: `cat provider.tf`
Purpose: Review current provider configuration patterns

**Step 4: Read existing docs**

Run: `cat docs/zadatak1/zadatak1.md`
Purpose: Understand project documentation style/tone for consistency

---

### Task 2: Create guide skeleton with main sections

**Files:**
- Create: `docs/provider-versioning.md`

**Step 1: Create file with section headers**
...
Run: `ls -la docs/provider-versioning.md`
Expected: File exists

**Step 3: Commit**

```bash
git add docs/provider-versioning.md
git commit -m "docs: add provider versioning guide skeleton"
```

---

### Task 3: Write Section 1 - Why Provider Versioning Matters

**Files:**
- Modify: `docs/provider-versioning.md`

**Step 1: Write section content**

Replace `<!-- TODO -->` in Section 1 with:
...
Run: `head -n 40 docs/provider-versioning.md`
Expected: Section 1 content visible

**Step 3: Commit**

```bash
git add docs/provider-versioning.md
git commit -m "docs: add 'Why Provider Versioning Matters' section"
```

---

### Task 4: Write Section 2 - Version Constraint Syntax

**Files:**
- Modify: `docs/provider-versioning.md`

**Step 1: Write version constraint syntax section**

Replace `<!-- TODO -->` in Section 2 with:
...
Run: `sed -n '/## 2. Version/,/## 3./p' docs/provider-versioning.md | head -50`
Expected: Section 2 content visible with proper formatting

**Step 3: Commit**

```bash
git add docs/provider-versioning.md
git commit -m "docs: add 'Version Constraint Syntax' section with examples"
```

---

### Task 5: Write Section 3 - Dependency Lock File

**Files:**
- Modify: `docs/provider-versioning.md`

**Step 1: Write lock file section**

Replace `<!-- TODO -->` in Section 3 with:
...
```bash
git add docs/provider-versioning.md
git commit -m "docs: add 'Dependency Lock File' section"
```

---

### Task 6: Write Section 4 - Provider Configuration

**Files:**
- Modify: `docs/provider-versioning.md`

**Step 1: Write provider configuration section**

Replace `<!-- TODO -->` in Section 4 with:
...
```bash
git add docs/provider-versioning.md
git commit -m "docs: add 'Provider Configuration' section with alias example"
```

---

### Task 7: Write Section 5 - Upgrade Workflows

**Files:**
- Modify: `docs/provider-versioning.md`

**Step 1: Write upgrade workflows section**

Replace `<!-- TODO -->` in Section 5 with:
...
git commit -m "chore: upgrade aws provider to v6"
```
...
```bash
git add docs/provider-versioning.md
git commit -m "docs: add 'Upgrade Workflows' section with rollback guide"
```

---

### Task 8: Write Section 6 - Best Practices Checklist
...
Replace `<!-- TODO -->` in Section 6 with:
...
```bash
git add docs/provider-versioning.md
git commit -m "docs: add 'Best Practices Checklist' section"
```

---

### Task 9: Add table of contents anchors and final review
...
Run: `wc -l docs/provider-versioning.md`
Expected: ~300+ lines

Run: `grep -c "^##" docs/provider-versioning.md`
Expected: 6+ main sections

**Step 3: Test markdown rendering**

Run: `head -50 docs/provider-versioning.md`
Expected: Proper markdown syntax visible

**Step 4: Final commit**

```bash
git add docs/provider-versioning.md
git commit -m "docs: complete provider versioning guide with TOC and references"
```

---

### Task 10: Update README to reference the new guide

**Files:**
- Modify: `README.md`

**Step 1: Add link to new guide**

Add after "Backend permissions" section:
...
```bash
git add README.md
git commit -m "docs: add link to provider versioning guide in README"
```
...
- This is a documentation-only task (no tests needed)
- Each commit is small and focused
- Use existing project files as examples
